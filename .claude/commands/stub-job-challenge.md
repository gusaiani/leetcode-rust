...
1. Read the "Solved Problems" tables in ALL sibling repos:
...
3. Pick a LeetCode problem that:
   ...
   - matches the requested difficulty mix over time: 50% easy / 40% medium / 10% hard. Look at the recent additions across all four repos and choose the difficulty that keeps the running mix on target.
